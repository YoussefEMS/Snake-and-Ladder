...
def open_messagebox():
    ...
    def filemenu():
        folder = resolve_path("\\Saves\\OneVOneE")
    ...
    def NEWGAME():
        ...
        Player1Score=CTkLabel(root, text=Counter1, font=("Arial", 20), fg_color="white", text_color="black", width=100, height=25).place(x=1110, y=200)
        Player2Score=CTkLabel(root, text=Counter2, font=("Arial", 20), fg_color="white",text_color="black", width=100, height=25).place(x=1210, y=200)
        rules()
        Background.configure(size=(1370,900))
        top.destroy()
...
def start_new_game():
    ...
    while (Player2.isalpha() == False):
        msg2 = CTkInputDialog(title="Player 2 name", text="Invalid!! \n Your name should not contain numbers")
        Player2=msg2.get_input()
    Player1Score=CTkLabel(root, text=Counter1, font=("Arial", 20), fg_color="white", text_color="black", width=100, height=50).place(x=1110, y=200)
    Player2Score=CTkLabel(root, text=Counter2, font=("Arial", 20), fg_color="white",text_color="black", width=100, height=50).place(x=1210, y=200)
    Player1Name=CTkLabel(root, text=Player1, font=("Arial", 17), fg_color="orange",text_color="white", anchor="center", width=100, height=30).place(x=1110, y=170)
    Player2Name=CTkLabel(root, text=Player2, font=("Arial", 17), fg_color="black",text_color="white", anchor="center", width=100, height=30).place(x=1210, y=170)
    ButtonPlayer1=CTkButton(root, text=Player1, height=50, width=100 ,hover_color="white", fg_color='orange',state=State1, command=diceimg1).place(x=785,y=450)
...
def load_game(loadedfile):
    ...
    global ButtonPlayer1
    global ButtonPlayer2
    Load = open(resolve_path(f"\\Saves\\OneVOneE\\{loadedfile}.txt"), "r")
    Mode=Load.readline()
...
def save_game():
    ...
    F=open(resolve_path(f"\\Saves\\OneVOneE\\{FileName}.txt"), "w")
